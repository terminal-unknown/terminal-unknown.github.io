...
exports.input = async function (value) {
 ...
 * @returns {undefined}
 */
exports.addHistory = function (value) {
 ...
 * @returns {undefined}
 */
exports.output2 =  function(text, options = {}, container = document.querySelector("#term-content"), waitval) {
...
exports.waitKey = async function () {
    const handle = () => {
